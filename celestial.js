...
!(function() {
    ...
    //Defaults
    var settings = { 
        width: 500,     // Default width; height is determined by projection
        ...
        stars: {
          ...
          limit: 5.5,      // Show only stars brighter than limit magnitude
          ...
          propernameStyle: { fill: "#ddddbb", font: "0 'Palatino Linotype', Georgia, Times, 'Times Roman', serif", align: "right", baseline: "bottom" },
        ...
        planets: {  //Show planet locations, if date-time is set
          ...
          symbols: {
            ...
            "lun": {symbol: "\u25cf", letter:"L", fill: "#ffffff", size: 30},
